...
date:firebase.firestore.Timestasmp.now().toDate(),
transtype:"issue"
...
<TextInput placeholder='Enter Book id' style={styles.inputbox} value={this.state.scannedbookid} />
...
<Text style={styles.buttontext}>
    Scan
        ...
        <View style={styles.inputview}>
<TextInput placeholder='Enter Student id' style={styles.inputbox} value={this.state.scannedstudentid} />
<TouchableOpacity style={styles.scanbutton} onPress={()=>{
